...
<div class="landingpage">
	<div class="tabs-content" id="tabsLandingpage" style="padding-top: 50px;">
		<div class="tab-pane fade in active" role="tabpanel" id="gioithieu" aria-labelledby="gioithieu-tab">
		...
		<div class="tab-pane" role="tabpanel" id="tinhnang" aria-labelledby="tinhnang-tab">
		...
		<div class="tab-pane" role="tabpanel" id="doitac" aria-labelledby="doitac-tab">
			<div class="company">
		...
		<div class="tab-pane" role="tabpanel" id="capkho" aria-labelledby="capkho-tab">	
		...
		<div class="tab-pane" role="tabpanel" id="dichvu" aria-labelledby="dichvu-tab">
