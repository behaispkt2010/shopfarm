...
{
    protected $fillable = ['title','price_in', 'price_out', 'price_sale','gram','min_gram','inventory','inventory_num','kho','title_seo', 'slug', 'category','content','description','image','author_id','status','count_view'];
